...
const loginSchema = z.object({
  repeatPassword: z.string().min(8, 'For the password, it must be 8 characters long '),
          ...
          {({ errors, touched, handleChange, values, setFieldValue }) => (
            <Box component={Form} noValidate>
              <Stack direction='column' justifyContent='center' spacing={2}>
                ...
                <Button type='submit' style={{ marginBottom: '40px' }} sx={{ color: '#fff', backgroundColor: '#1D8D94', '&:hover': { backgroundColor: '#147a81' } }}>
                  confirm
                </Button>
