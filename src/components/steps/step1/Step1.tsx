            ...
            <Stack sx={{ position: 'relative' }}>
                ...
                <Button onClick={exChangeHandler} sx={{ width: '69px', height: '69px', backgroundColor: '#242C39', borderRadius: '50%', color: '#F3AC76', position: 'absolute', top: '39%', left: 'calc(50% - 34px)' }}>
                   <svg width="21" height="27" viewBox="0 0 21 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <line x1="0.353478" y1="6.77145" x2="6.29098" y2="0.833947" stroke="#F3AC76" />
                        <line y1="-0.5" x2="9.46747" y2="-0.5" transform="matrix(-0.752577 0.658505 -0.752577 -0.658505 19.707 18.7031)" stroke="#F3AC76" />
                    </svg>
                </Button>
                <Card sx={{
                    mt: '27px',
